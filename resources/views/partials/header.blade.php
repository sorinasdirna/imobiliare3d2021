<div class="panel panel--header">
    <div class="grid grid_align-middle">
        ...
        <div class="header-nav grid_col grid_col--6-of-8 grid_col--lc-1-of-2 grid_col--md-1-of-2 grid_col--sm-1-of-2">
        ...
        <div class="nav-right grid_col grid_col--1-of-8 desktop--only text-right">
            <ul>
                <li><a href="tel:0000-0000-000"><i class="fa fa-phone"></i> 0000 0000 000</a></li>
            </ul>
        </div> 
