                        ...
                        <div class="control-wrap-inner">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_description')?' has-error':''}}">
                                    <textarea class="textarea_editor span12" name="p_description" id="p_description" rows="6" placeholder="">{{old('p_description')}}</textarea>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_price')?' has-error':''}}">
                                    <div class="input-prepend"> <span class="add-on">$</span>
                                        <input type="number" name="p_price" id="p_price" class="form-control" value="{{old('p_price')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_pricemp2')?' has-error':''}}">
                                    <div class="input-prepend"> <span class="add-on">$</span>
                                        <input type="number" name="p_pricemp2" id="p_pricemp2" class="form-control" value="{{old('p_pricemp2')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_rooms')?' has-error':''}}">
                                    <input type="number" name="p_rooms" id="p_rooms" class="form-control" value="{{old('p_rooms')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_baths')?' has-error':''}}">
                                    <input type="number" name="p_baths" id="p_baths" class="form-control" value="{{old('p_baths')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_balconies')?' has-error':''}}">
                                    <input type="number" name="p_balconies" id="p_balconies" class="form-control" value="{{old('p_balconies')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_hallways')?' has-error':''}}">
                                    <input type="number" name="p_hallways" id="p_hallways" class="form-control" value="{{old('p_hallways')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_typeof')?' has-error':''}}">
                                    <input type="text" name="p_typeof" id="p_typeof" class="form-control" value="{{old('p_typeof')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_furniture')?' has-error':''}}">
                                    <input type="text" name="p_furniture" id="p_furniture" class="form-control" value="{{old('p_furniture')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_material')?' has-error':''}}">
                                    <input type="text" name="p_material" id="p_material" class="form-control" value="{{old('p_material')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_floor')?' has-error':''}}">
                                    <input type="text" name="p_floor" id="p_floor" class="form-control" value="{{old('p_floor')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_totalfloors')?' has-error':''}}">
                                    <input type="text" name="p_totalfloors" id="p_totalfloors" class="form-control" value="{{old('p_totalfloors')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_totalsurface')?' has-error':''}}">
                                    <input type="text" name="p_totalsurface" id="p_totalsurface" class="form-control" value="{{old('p_totalsurface')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_usablesurface')?' has-error':''}}">
                                    <input type="text" name="p_usablesurface" id="p_usablesurface" class="form-control" value="{{old('p_usablesurface')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_year')?' has-error':''}}">
                                    <input type="text" name="p_year" id="p_year" class="form-control" value="{{old('p_year')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_condition')?' has-error':''}}">
                                    <input type="text" name="p_condition" id="p_condition" class="form-control" value="{{old('p_condition')}}" title="">
                    ...
                    <div class="control-wrap-outer">
                        ...
                        <div class="control-wrap-inner">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_address')?' has-error':''}}">
                                    <input type="text" name="p_address" id="location" class="form-control" value="{{old('p_address')}}" title="">
                                    <span class="text-danger">{{$errors->first('p_address')}}</span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_addresslat')?' has-error':''}}">
                                    <input type="text" name="p_addresslat" id="lat" class="form-control" value="{{old('p_addresslat')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_addresslon')?' has-error':''}}">
                                    <input type="text" name="p_addresslon" id="lng" class="form-control" value="{{old('p_addresslon')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_neighborhood')?' has-error':''}}">
                                    <input type="text" name="p_neighborhood" id="p_neighborhood" class="form-control" value="{{old('p_neighborhood')}}" title="">
                        ...
                        <div class="control-wrap-inner">
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_clientname')?' has-error':''}}">
                                    <input type="text" name="p_clientname" id="p_clientname" class="form-control" value="{{old('p_clientname')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_clientphone')?' has-error':''}}">
                                    <input type="text" name="p_clientphone" id="p_clientphone" class="form-control" value="{{old('p_clientphone')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_clientaddress')?' has-error':''}}">
                                    <input type="text" name="p_clientaddress" id="p_clientaddress" class="form-control" value="{{old('p_clientaddress')}}" title="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_clientdescription')?' has-error':''}}">
                                    <textarea class=" span12" name="p_clientdescription" id="p_clientdescription" rows="6" placeholder="">{{old('p_clientdescription')}}</textarea>
