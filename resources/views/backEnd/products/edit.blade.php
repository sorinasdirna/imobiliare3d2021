                        ...
                        <div class="control-wrap-inner">
                            <div class="control-group">
                                <div class="controls{{$errors->has('p_address')?' has-error':''}}">
                                    <input type="text" name="p_address" id="searchInput" class="form-control" value="{{old('p_address')}}" title="" style="width: 400px;">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_address')?' has-error':''}}">
                                    <input type="text" name="p_address" id="location" class="form-control" value="{{$edit_product->p_address}}" title="" style="width: 400px;">
                                    <span class="text-danger">{{$errors->first('p_address')}}</span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_addresslat')?' has-error':''}}">
                                    <input type="text" name="p_addresslat" id="lat" class="form-control" value="{{$edit_product->p_addresslat}}" title="" style="width: 400px;">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls{{$errors->has('p_addresslon')?' has-error':''}}">
                                    <input type="text" name="p_addresslon" id="lng" class="form-control" value="{{$edit_product->p_addresslon}}" title="" style="width: 400px;">
